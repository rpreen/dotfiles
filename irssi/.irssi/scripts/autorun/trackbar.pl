...
#     the upgrade is done, so buf.pl does not restore them, as they are not removable
...
#  irssi to 'forget' lines, which is ofcourse completely unaccepteable.  I haven't found the time
#  nor do I know the irssi's internals enough to find and fix this bug, if you want to help, please
#  contact me, I'll give you a copy of the 2.0 version that will immediately show you the problems.
#
# Known bugs:
#  - if you /clear a window, it will be uncleared when returning to the window
#  - UTF-8 characters in the trackbar_string doesn't work.  This is an irssi bug.
