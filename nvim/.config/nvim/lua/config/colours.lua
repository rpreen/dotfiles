...
hl(0, "PmenuSel", { fg = c.bg, bg = c.wombat_green })
hl(0, "WildMenu", { fg = c.bg, bg = c.wombat_green })
...
hl(0, "RenderMarkdownCode", { bg = c.off_black })

hl(0, "TelescopeSelection", { fg = c.bg, bg = c.wombat_green })
