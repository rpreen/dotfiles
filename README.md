...
1. Get v0.25.10 x86 from [tree-sitter releases](https://github.com/tree-sitter/tree-sitter/releases)
...
Get the latest x86 from [releases](https://github.com/sxyazi/yazi/releases)
